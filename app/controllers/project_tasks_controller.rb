...
class ProjectTasksController < ApplicationController
  ...
  def project_task_params
    params.require(:project_task).permit(
        :pa_id, :interview_form, :started_at, :expert_level, :expert_rate, :duration, :charge_duration, :actual_price,
        :is_shorthand, :shorthand_price, :is_recorded, :memo, :f_flag, :expert_alias, :expert_company, :expert_title)
  end
