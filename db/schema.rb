...
ActiveRecord::Schema.define(version: 2020_05_20_121303) do
  ...
  create_table "candidate_experiences", force: :cascade do |t|
    ...
    t.index ["org_cn"], name: "index_candidate_experiences_on_org_cn"
    t.index ["org_en"], name: "index_candidate_experiences_on_org_en"
    t.index ["title"], name: "index_candidate_experiences_on_title"
  end
